...
exports.changePassword = exports.verifyResetPasswordToken = exports.sendResetPasswordEmail = void 0;
...
const sendResetPasswordEmail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        transporter.sendMail(mailOptions, (err, response) => __awaiter(void 0, void 0, void 0, function* () {
            if (err) {
